...
//        as.numberOfArithmeticSlicesII(new int[]{1, 1, 2, 3, 4, 5});
//        BuySellStock buySell = new BuySellStock();
//        buySell.maxProfit1(new int[]{1, 3, 2, 8, 4, 9}, 2);
//        BuySellStockIII buySell = new BuySellStockIII();
//        buySell.maxProfit(new int[] {3,3,5,0,0,3,1,4});
//        ArithmeticSlicesLength arithMetics = new ArithmeticSlicesLength();
//        arithMetics.longestSubsequence(new int[]{1,2,3,4}, 1);
//        MiniCostLeafTree miniCostLeafTree = new MiniCostLeafTree();
//        miniCostLeafTree.mctFromLeafValuesDP1(new int[]{6,2,4});
//        LongestStrChain longestStr = new LongestStrChain();
//        longestStr.logestStrChainDfs(new String[]{"ksqvsyq","ks","kss","czvh","zczpzvdhx","zczpzvh","zczpzvhx","zcpzvh","zczvh","gr","grukmj","ksqvsq","gruj","kssq","ksqsq","grukkmj","grukj","zczpzfvdhx","gru"});
//        NumRollsToTarget numRollsTarget = new NumRollsToTarget();
//        numRollsTarget.numRollsToTargetDP(2, 6, 7);
//        LargestSumOfAverage la = new LargestSumOfAverage();
//        la.largestSumOfAveragesRecursiveWithMemo(new int[]{9,1,2,3,9}, 3);
//        MaxSubArraySum msas = new MaxSubArraySum();
//        msas.maximumSum(new int[]{-1,-1,-1,-1});
//        KConcatenationMaxSum maxSum = new KConcatenationMaxSum();
//        maxSum.kConcatenationMaxSum(new int[]{-5,-2,0,0,3,9,-2,-5,4},
//        5);
//        Decodeway decode = new Decodeway();
//        decode.numDecodingsDPLessMemory("10");
//        MaxSumDivThree maxSum3 = new MaxSumDivThree();
//        maxSum3.maxSumDivThreeDP(new int[]{ 3, 6, 5, 1, 8});
//        String[] test = new String[]{"test"};
//        MaxTreeProduct.TreeNode tree = new TreeNode(1);
//        MaxTreeProduct maxTreeProduct = new MaxTreeProduct();
//        maxTreeProduct.maxProduct();
    }
}